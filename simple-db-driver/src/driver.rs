...
mod tests {
    use super::*;
    use simple_db_query::{queries::{DeleteQuery, FindQuery, InsertQuery, UpdateQuery}, types::DbRow};
    use async_trait::async_trait;
    ...
    impl DbDriver for MockDriver {
        async fn find(&self, _query: FindQuery) -> Result<Box<dyn DbCursor>, DbError> {
